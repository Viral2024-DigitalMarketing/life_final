...
const GeneralHealthPage = () => {
    ...
    const renderTag = (text: string, borderColor: string, textColor: string, iconPath: string) => (
        ...
        >
            <img src={iconPath} alt="Icon" className="w-4 h-4 mr-1" />
            <span className={`text-[14px] font-normal capitalize ${textColor}`}>{text}</span>
        </div>
    );
            ...
            <main className="flex-grow pt-24 pb-16 bg-white">
                <div className="mt-6 mb-4">
                    <div className="text-center mb-8 px-4">
                        <h1 className="text-[40px] sm:text-[64px] font-semibold font-['Abhaya Libre SemiBold'] leading-none text-[#3B3B56]">
                            General Health
                        </h1>
                    </div>
                    ...
                    {[{
                        ...
                        <div
                            key={index}
                            className={`w-full lg:w-[1280px] mx-auto px-4 sm:px-8 py-8 mb-14 flex flex-col lg:flex-row ${
                                section.imagePosition === "left" ? "lg:flex-row-reverse" : ""
                            } ${section.bgColor} ${section.borderColor} border-2 rounded-[24px]`}
                        >
                            <div className="w-full lg:w-1/2 flex flex-col justify-between mb-6 lg:mb-0 lg:px-6 mt-6">
                                <div>
                                    <h2 className="font-['Be Vietnam Pro'] font-medium text-[28px] sm:text-[36px] leading-[100%] text-black mb-6">
                                        {section.title}
                                    </h2>
                                    <p className="text-[15px] sm:text-[16px] font-medium mb-8">
                                        {section.description}
                                    </p>
                                    ...
                                    <div
                                        ...
                                        className={`w-full max-w-[248px] h-[44px] ${section.buttonColor} rounded-[12px] flex items-center justify-center cursor-pointer text-white text-[18px]`}
                                    >
                            ...
                            <div className="w-full lg:w-[614px] h-[300px] sm:h-[400px] lg:h-[510px] rounded-[20px] overflow-hidden">
