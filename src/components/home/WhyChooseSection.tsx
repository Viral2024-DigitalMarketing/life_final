...
const WhyChooseSection = () => {
    ...
    return (
        <div className="bg-white font-['Abhaya_Libre'] overflow-hidden">
            ...
            >
                <div className="container mx-auto px-4">
                    <div className="relative w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
                        <div className="relative w-full lg:w-1/2 h-[350px] sm:h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center mx-auto">
                            <motion.div
                                className="absolute w-full h-full z-[3] top-0 lg:top-[-60px] right-0 lg:right-[-30px]"
                            ...
                            <motion.div
                                className="absolute w-full h-full z-[4] top-[5px] md:top-[-30px] lg:top-[-90px] right-[5px] md:right-[-20px] lg:right-[-50px]"
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={
                                    section1Animated.current
                                        ? { opacity: [1, 1, 0], scale: [1, 1, 0.8], x: [0, 0, 100], rotateZ: [0, 0, 180] }
                            ...
                            <motion.div
                                className="absolute w-full h-full z-[5] top-[10px] md:top-[-60px] lg:top-[-120px] right-[10px] md:right-[-40px] lg:right-[-70px]"
                                initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <motion.div
                            className="w-full lg:w-1/2 relative z-[10] mt-8 lg:mt-0 mx-auto"
            ...
            <motion.div
                ref={ref2}
                className="min-h-[90vh] md:min-h-screen flex items-center justify-center py-12 md:py-20 relative"
                initial={{ opacity: 0, y: 50 }}
                animate={inView2 ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.8 }}
            >
                <div className="container mx-auto px-4 md:mt-[-100px] lg:mt-[-300px]">
                        ...
                        <div className="w-full lg:w-1/2 relative mx-auto">
                            <div className="relative h-[350px] sm:h-[400px] md:h-[500px] lg:h-[600px]">
                                ...
                                >
                                    ...
                                    {/* Text on Yellow Blob (visible only when it arrives) */}
                                    <motion.div
                                        className="absolute inset-0 flex flex-col items-center lg:items-start justify-center p-4 sm:p-6 md:p-8 lg:p-12 text-center lg:text-left"
                                        initial={{ opacity: 0 }}
                                        animate={
